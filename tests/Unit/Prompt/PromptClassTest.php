...
final class PromptClassTest extends TestCase
{
    ...
    public function testWithParametersReturnsTheSameInstanceWhenNothingMatches(): void
    {
        $prompt = new SystemPrompt('Hi {{name}}');

        $this->assertSame($prompt, $prompt->withParameters(['other' => 'x']));
    }
}

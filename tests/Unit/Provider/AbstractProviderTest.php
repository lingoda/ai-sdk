...
final class AbstractProviderTest extends ProviderTestCase
{
    ...
    public function testGetDefaultModelThrowsWhenTheProviderHasNoModels(): void
    {
        $this->expectException(ModelNotFoundException::class);
        $this->expectExceptionMessage('No models available for provider "test-provider"');

        (new TestableProvider([]))->getDefaultModel();
    }
}
